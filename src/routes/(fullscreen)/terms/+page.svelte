<div class="prose">
  <h1 id="-developer-name-terms-of-service"><strong>ROROOMS.COM</strong> TERMS OF SERVICE</h1>
<p>Last Updated: <strong>10/04/2024</strong></p>
<p>These terms of service (&quot;Terms&quot;) apply to your access and use of <strong>rorooms.com</strong> (the &quot;Service&quot;). Please read them carefully.</p>
<h2 id="accepting-these-terms">Accepting these Terms</h2>
<p>If you access or use the Service, it means you agree to be bound by all of the terms below. So, before you use the Service, please read all of the terms. If you don&#39;t agree to all of the terms below, please do not use the Service. Also, if a term does not make sense to you, please let us know by e-mailing <strong>contact@rorooms.com</strong>.</p>
...
<p>Whenever we make changes to these Terms, the changes are effective <strong>immediately</strong> after we post such revised Terms (indicated by revising the date at the top of these Terms) or upon your acceptance if we provide a mechanism for your immediate acceptance of the revised Terms (such as a click-through confirmation or acceptance button). It is your responsibility to check <strong>rorooms.com</strong> for changes to these Terms.</p>
...
<p>For information about how we collect and use information about users of the Service, please check out our privacy policy available at <strong>rorooms.com/privacy</strong>.</p>
...
<li>Content that violates <a href="https://en.help.roblox.com/hc/en-us/articles/115004647846-Roblox-Terms-of-Use">Roblox's Terms of Use</a>.</li>
</ul>
...
<h2 id="-developer-name-materials"><strong>rorooms.com</strong> Materials</h2>
...
<h2 id="hyperlinks-and-third-party-content">Hyperlinks and Third Party Content</h2>
...
<p>The validity of these Terms and the rights, obligations, and relations of the parties under these Terms will be construed and determined under and in accordance with the laws of the <strong>United States</strong>, without regard to conflicts of law principles.</p>
<h2 id="jurisdiction">Jurisdiction</h2>
<p>You expressly agree that exclusive jurisdiction for any dispute with the Service or relating to your use of it, resides in the courts of the <strong>United States</strong> in connection with any such dispute including any claim involving Service. You further agree that you and Service will not commence against the other a class action, class arbitration or other representative action or proceeding.</p>
...
<p>These Terms constitute the entire agreement between you and <strong>rorooms.com</strong> regarding the use of the Service, superseding any prior agreements between you and <strong>rorooms.com</strong> relating to your use of the Service.</p>
<h2 id="feedback">Feedback</h2>
<p>Please let us know what you think of the Service, these Terms and, in general, <strong>rorooms.com</strong>. When you provide us with any feedback, comments or suggestions about the Service, these Terms and, in general, <strong>rorooms.com</strong>, you irrevocably assign to us all of your right, title and interest in and to your feedback, comments and suggestions.</p>
<h2 id="questions-contact-information">Questions &amp; Contact Information</h2>
<p>Questions or comments about the Service may be directed to us at the email address <strong>contact@rorooms.com</strong>.</p>
